...
m = ConvModel(data = md, convolutions = [16,32], pooling = [4,2], mlp = [8], batch = 8, dropout = 0.5, name="med-16-32", optimizer='rmsprop', epochs=50)
if args.train:
    m.train()
else:
    m.test()
...
m = ConvModel(data = md, convolutions = [32,32], pooling = [4,2], mlp = [8], batch = 8, dropout = 0.5, name="med-32-32", optimizer='rmsprop', epochs=50)
if args.train:
    m.train()
else:
    m.test()
...
m = ConvModel(data = md, convolutions = [32,64], pooling = [4,2], mlp = [8], batch = 8, dropout = 0.5, name="med-32-64", optimizer='rmsprop', epochs=50)
if args.train:
    m.train()
else:
    m.test()
