...
class Dataset2(object):
    ...
    def __init__(self, img_width=160, img_height=120, batch_size=8):
        ...
        self.train_generator = self.train_gen.flow_from_directory(os.path.join("dataset2-master", "images", "TRAIN"), target_size=(self.img_height, self.img_width), batch_size=self.batch_size)
        self.validation_generator = self.val_gen.flow_from_directory(os.path.join("dataset2-master", "images", "TEST"), target_size=(self.img_height, self.img_width), batch_size=self.batch_size)
        self.test_generator = self.val_gen.flow_from_directory(os.path.join("dataset2-master", "images", "TEST"), target_size=(self.img_height, self.img_width), batch_size=self.batch_size)
        #self.test_generator = self.test_gen.flow_from_directory(os.path.join("dataset2-master", "images", "TEST_SIMPLE"), target_size=(self.img_width, self.img_height), batch_size=self.batch_size)
