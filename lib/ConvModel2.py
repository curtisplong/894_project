...
class ConvModel(object):
    ...
    def build(self):
        ...
        for y in self.mlp:
            self.model.add(Dense(y, activation=self.activation))
    ...
    def train(self):
        ...
        self.hist = self.model.fit_generator(
            ...
            steps_per_epoch=len(self.ds.train_generator) // self.batch_size,
            validation_data=self.ds.validation_generator,
            validation_steps=len(self.ds.validation_generator) // self.batch_size,
            epochs=self.epochs,
